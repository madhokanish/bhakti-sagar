...
private val table: Map<String, Entry> = mapOf(
    ...
    "promo_badge" to Entry("3 DIN FREE", "3 दिन मुफ़्त", "3 DAYS FREE"),
    ...
    "guide_status_krishna" to Entry("Online", "ऑनलाइन", "Online"),
    ...
    "guide_status_lakshmi" to Entry("Online", "ऑनलाइन", "Online"),
    ...
    "guide_status_shani" to Entry("Online", "ऑनलाइन", "Online"),
    ...
    "guide_status_shiv" to Entry("Online", "ऑनलाइन", "Online"),
    ...
    "guide_status_hanuman" to Entry("Online", "ऑनलाइन", "Online"),
    ...
    "chat_guru_available" to Entry("Online", "ऑनलाइन", "Online"),
