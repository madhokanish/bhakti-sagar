...
export const metadata: Metadata = buildMetadata({
  title: "Weekly Ganesh Membership (Wednesday Puja)",
  description:
    "Join Weekly Ganesh Membership for Wednesday puja. 4 pujas per month in your name with live access, replay, and certificate.",
...
export default function GaneshWeeklyMembershipPage() {
  ...
  const breadcrumb = breadcrumbJsonLd([
    ...
    { name: "Ganesh Weekly Membership", url: "https://bhakti-sagar.com/online-puja/ganesh-weekly" }
  ]);
