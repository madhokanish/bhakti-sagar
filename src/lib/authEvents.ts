...
export const AUTH_EVENT_TYPES = {
  ...
  MOBILE_GOOGLE_LOGIN_SUCCESS: "MOBILE_GOOGLE_LOGIN_SUCCESS",
  MOBILE_REVIEW_LOGIN_SUCCESS: "MOBILE_REVIEW_LOGIN_SUCCESS",
  MOBILE_ACCESS_LOGIN_SUCCESS: "MOBILE_ACCESS_LOGIN_SUCCESS",
